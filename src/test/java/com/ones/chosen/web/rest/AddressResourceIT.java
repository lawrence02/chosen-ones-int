...
import com.ones.chosen.domain.Address;
import com.ones.chosen.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY).stateProvince(UPDATED_STATE_PROVINCE);
